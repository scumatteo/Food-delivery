...
<head>
  ...
  <script src="../js/seller_homepage.js" type="text/javascript"></script>
...
<body>
      ...
      <div class="nav-guest-items ml-3 ml-md-auto"> <!-- for registered user -->
        <ul class="navbar-nav">
          <li id ="accountList" class="nav-item ml-3 dropdown">
            ...
            <a class="nav-link d-block d-md-none" href="#"><i class="far fa-user" title="user icon to logout or to go to product page"></i></a>
            <div class="dropdown-content">
              <a class="dropdown-item" href="seller_product_page.php">Prodotti</a>
  ...
  <div class="container-fluid">
    <div class="container-fluid todo">
      <a href="#">Scegli un ordine da confermare</a>
      <div id="todo" class="card-group">
      </div>
    </div>
    <div class="container-fluid todo">
      <a href="#">Stato degli ordini</a>
      <div id="stato" class="card-group">
      </div>
    </div>
